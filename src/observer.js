...
const api_base = process.env.REACT_APP_API_BASE || `https://dev-oracle.dlc.link/btc1/extended/v1`;
const ioclient_uri = process.env.REACT_APP_IO_CLIENT_URI || `wss://dev-oracle.dlc.link`;
